...
const TransactionComponent = () => {
  ...
  <div className="mb-1">
                  ...
                  <input type="datetime-local" className={`form-control ${errors.transactionDate ? 'is-invalid' : ''}`} name='transactionDate' value={transactionDate} onChange={(e) => setTransactionDate(e.target.value)} />
